...
const Welcome = () => (
    <div className="welcome">
        ...
        <div className="welcome__textbox__main__content">
            <h2 className="welcome__main__content--subheading">Welcome to the Arch Studio</h2>
            <p className="welcome__main__content--paragraph">
