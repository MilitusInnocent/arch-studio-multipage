    ...
    return (
        <div className="contact__details">
            ...
            <div className="contact__details__info">
                <h2 className="contact__details__info--heading">Contact Details</h2>
                <div className="contact__details__info--locations">
                    <div className="contact__details__info--locations-main">
                        ...
                        <a className="contact__details__info--locations--redirect" href="#map">
            ...
            <div className="contact__details__map__container" id="map">
                <img 
                    ...
                    src={
                        viewport > 800 
                            ? require(`../images/contact/desktop/image-map.png`)
                                : viewport > 500
                                    ? require(`../images/contact/tablet/image-map.png`)
                                    : require(`../images/contact/mobile/image-map.png`)
                    } 
